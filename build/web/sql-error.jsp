<%-- 
    Document   : sql-error
    Created on : 11 Jan, 2022, 11:34:13 AM
    Author     : VAIBHAV
--%>
...
* {
    ...
    <body>
        <h1>There is Error in the values you have provided </h1><br>
        <h1>PLEASE PROVIDE CORRECT VALUE </h1><br>
        <a href="manageS.jsp">GO BACK </a><br>
    </body>
</html>
