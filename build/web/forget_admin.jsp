<%-- 
    Document   : forget_admin
    Created on : 14 Dec, 2021, 6:17:53 PM
    Author     : Admin
--%>
...
* {
    ...
    <body>
        <form action ="forget_adminjstl.jsp" method="get">
            <input type="text" class="fadeIn second" name="id" placeholder="Enter your Name">
