<%-- 
    Document   : showMarks
    Created on : 11 Jan, 2022, 12:44:48 PM
    Author     : VAIBHAV
--%>
...
* {
    ...
    <body>
        ...
        <%
            ...
            PreparedStatement ps=con.prepareStatement("select Name,Percentage from marks ORDER by Percentage desc");
            ...
            while(rs.next())
            {
                out.println("<tr><td>"+i+"</td><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td></tr>");
                i++;
            }
